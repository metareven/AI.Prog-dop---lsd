Lyd = wavread('C:\Documents and Settings\Lars\Mine dokumenter\workspace\AI.Prog-dop---lsd\speech\Training Data\go_5.wav');
...
States = zeros(10,1);
for i = 1:Size(1),
    Fouriertransformer(i,:) = abs(fft(Lydbuffer(i,:)));
